                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <form onSubmit={eventHandler} className="p-6 flex flex-col justify-center">
                                <div className="flex flex-col">
                                    ...
                                    <input value={name} onChange={(e)=>setName(e.target.value)} type="name" name="name" id="name" placeholder="Full Name" className="w-100 mt-2 py-3 px-3 text-black rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 font-semibold focus:border-indigo-500 focus:outline-none"/>
                                </div>

                                <div className="flex flex-col mt-2">
                                    <label htmlFor="email" className="hidden">Email</label>
                                    <input onChange={(e)=>setEmail(e.target.value)} type="email" value={email} name="email" id="email" placeholder="Email" className="text-black w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700  font-semibold focus:border-indigo-500 focus:outline-none"/>
                                </div>

                                <div className="flex flex-col mt-2">
                                    <label htmlFor="message" className="hidden">Email</label>
                                    <textarea onChange={(e)=>{setMessage(e.target.value)}} type="text" value={message} name="message" id="message" placeholder="Type your message here.." className="text-black w-100 mt-2 py-10 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700  font-semibold focus:border-indigo-500 focus:outline-none"/>
                                </div>
