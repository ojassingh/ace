...
const Footer = () => {
    return(
        <footer className="m-10 p-4 bg-white sm:p-6 dark:bg-gray-900">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <a href="https://www.facebook.com/DECAUTSC/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <a href="https://www.instagram.com/aceutsc/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <a href="https://www.linkedin.com/company/deca-utsc/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg
                    fill="currentColor"
