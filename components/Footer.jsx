    ...
    return(
        ...
        <div className="mx-10 sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                ...
                <a target='_blank' href="https://www.linkedin.com/company/deca-utsc/" className="-mt-1 text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg
                    fill="currentColor"
                    ...
                    <span className="-mt-1 sr-only">LinkedIn account</span>
                </a>
            </div>
        </div>
    </footer>
